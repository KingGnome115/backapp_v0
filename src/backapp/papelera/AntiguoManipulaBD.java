 ...
 * @author Kevin
 */
public class AntiguoManipulaBD
{
...
//            return con.Conecta("127.0.0.1:3307", "backapp", "root", "", 2);
    ...
    {
        Connection con = AntiguoManipulaBD.conecta();
    ...
    public static ArrayList<CompanierosObj> ConsultaCompanieros(String variable, String condicion)
    {
        ...
        {
            Querys sql = new Querys();
            ap = AntiguoManipulaBD.cargarCom(sql.Seleccion(con, "*", "companieros", variable + condicion));
            desconecta(con);
        }
        return ap;
    }
    ...
    public static void ModificarCompanieros(int id, String campos, String datos)
    {
        ...
        {
            Querys sql = new Querys();
            ArrayList<CompanierosObj> ap = AntiguoManipulaBD.cargarCom(sql.Seleccion(con, "*", "companieros", "id=" + id + ""));
            if (ap != null)
            {
...
//                    v.add(obj);
    ...
    public static ArrayList<Materias> ConsultaMaterias(String variable, String condicion)
    {
        ...
        {
            Querys sql = new Querys();
            ap = AntiguoManipulaBD.cargarMaterias(sql.Seleccion(con, "*", "materias", variable + condicion));
            desconecta(con);
        }
        return ap;
    }
    ...
    public static void ModificarMaterias(int id, String campos, String datos)
    {
        ...
        {
            Querys sql = new Querys();
            ArrayList<Materias> ap = AntiguoManipulaBD.cargarMaterias(sql.Seleccion(con, "*", "materias", "id=" + id + ""));
            if (ap != null)
            {
...
//                    v.add(obj);
    ...
    public static ArrayList<Horarios> ConsultaHorarios(String variable, String condicion)
    {
        ...
        {
            Querys sql = new Querys();
            ap = AntiguoManipulaBD.cargarHorarios(sql.Seleccion(con, "*", "horarios", variable + condicion));
            desconecta(con);
        }
        return ap;
    }
    ...
    public static void ModificarHorarios(int id, String campos, String datos)
    {
        ...
        {
            Querys sql = new Querys();
            ArrayList<Horarios> ap = AntiguoManipulaBD.cargarHorarios(sql.Seleccion(con, "*", "horarios", "id=" + id + ""));
            if (ap != null)
            {
